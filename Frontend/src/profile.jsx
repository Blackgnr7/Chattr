    ...
    return(
        <div className="flex items-center justify-center flex-col">
            <div className="border-2 dark:border-white border-black p-7 text-white dark:text-white bg-black flex flex-col items-center">
                ...
                <button className="cursor-pointer border-2 p-2 mt-3 transition duration-300 ease-in-out hover:bg-green-600 disabled:hover:bg-red-600" onClick={enviar} id="enviar">Enviar</button>
            </div>
        </div>
    )
}
